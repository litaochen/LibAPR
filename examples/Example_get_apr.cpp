...
int main(int argc, char **argv) {
    ...
    apr.parameters.check_input = options.check_input;
    apr.parameters.swap_dimensions = options.swap_dimensions;

    apr.parameters.extra_smooth = options.extra_smooth;
...
cmdLineOptions read_command_line_options(int argc, char **argv){
    ...
    {
        result.quantization_factor = std::stof(std::string(get_command_option(argv, argv + argc, "-quantization_factor")));
    }
    ...
    if(command_option_exists(argv, argv + argc, "-extra_smooth"))
    {
        result.extra_smooth = std::stof(std::string(get_command_option(argv, argv + argc, "-extra_smooth")));
    }
